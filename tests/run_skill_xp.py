"""Run the real Skill/XP ModuleScripts with a minimal PlayerData test boundary."""
...
def main():
    ...
    modules = {
        ...
        "Definitions": root / "src/Server/Skills/Definitions.luau",
        "Service": root / "src/Server/Skills/Service.luau",
    }
...
''')
    wrappers.append((root / "tests/SkillXP.spec.luau").read_text(encoding="utf-8"))
    wrappers.append("end\nrunTests(moduleRequire)\n")

    with tempfile.TemporaryDirectory(prefix=".skill-xp-", dir=root / "tests") as directory:
